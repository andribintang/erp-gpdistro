...
<body class="min-h-screen bg-slate-950 text-slate-100 antialiased">
    <main class="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center px-6 text-center">
        <p class="text-sm uppercase tracking-[0.25em] text-amber-300">Error 500</p>
        <h1 class="mt-3 text-3xl font-semibold text-white">Terjadi Kesalahan Server</h1>
        <p class="mt-4 text-slate-300">Maaf, sistem sedang mengalami kendala. Silakan coba lagi beberapa saat lagi.</p>
