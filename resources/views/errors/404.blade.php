...
<body class="min-h-screen bg-slate-950 text-slate-100 antialiased">
    <main class="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center px-6 text-center">
        <p class="text-sm uppercase tracking-[0.25em] text-cyan-300">Error 404</p>
        <h1 class="mt-3 text-3xl font-semibold text-white">Halaman Tidak Ditemukan</h1>
        <p class="mt-4 text-slate-300">Halaman yang Anda cari tidak tersedia atau sudah dipindahkan.</p>
